...
- 如果有需要修改项：
  ...
  - Codex CLI: `/prompts:ai-collaboration-installer-refine-task {task-id}`
- 如果需要重大修改：
  - Claude Code / OpenCode: `/implement-task {task-id}`
  - Gemini CLI: `/ai-collaboration-installer:implement-task {task-id}`
  - Codex CLI: `/prompts:ai-collaboration-installer-implement-task {task-id}`
```
...
- Gemini CLI: `/ai-collaboration-installer:refine-task TASK-20251227-104654`
- Codex CLI: `/prompts:ai-collaboration-installer-refine-task TASK-20251227-104654`
```
