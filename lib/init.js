...
async function cmdInit() {
  ...
  copyFile(
    path.join(templateDir, '.agents', 'skills', 'update-ai-collaboration', 'scripts', 'sync-templates.js'),
    path.join('.agents', 'skills', 'update-ai-collaboration', 'scripts', 'sync-templates.js')
  );
  ok('Installed .agents/skills/update-ai-collaboration/scripts/sync-templates.js');
