# Codex Commands (ai-collaborator)

This directory contains Codex CLI prompts for the ai-collaborator repository.
...
**Project Setup**:
- `collaborator-init-project` - Initialize a new project from ai-collaborator templates
