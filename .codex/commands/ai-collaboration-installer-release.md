...
usage: /prompts:ai-collaboration-installer-release <version>
---
...
**用法：**
- `/prompts:ai-collaboration-installer-release 1.2.3` - 发布 1.2.3 版本
...
3. （可选）生成 Release Notes:
       ...
       - Gemini CLI: /ai-collaboration-installer:create-release-note X.Y.Z
       - Codex CLI: /prompts:ai-collaboration-installer-create-release-note X.Y.Z
```
...
```bash
/prompts:ai-collaboration-installer-release 1.2.3
```
...
- `/prompts:ai-collaboration-installer-create-release-note` - 生成 Release Notes 并创建 GitHub Draft Release
- `/prompts:ai-collaboration-installer-commit` - 提交代码
- `/prompts:ai-collaboration-installer-test` - 运行测试
