...
**用法：**
- `/prompts:ai-collaboration-installer-commit` - 查看提交指南
...
Edit(
  ...
  old_string="Copyright (C) 2024-2025 fitlab-ai",
  new_string="Copyright (C) 2024-2026 fitlab-ai"
)

# 格式 2：单一年份
Edit(
  file_path="src/another.java",
  old_string="Copyright (C) 2024 fitlab-ai",
  new_string="Copyright (C) 2024-2026 fitlab-ai"
)
```
...
# Copyright (C) 2024-2025 fitlab-ai
...
# 7. 验证更新
grep "Copyright" src/main/Example.java
# Copyright (C) 2024-2026 fitlab-ai
...
/review-task <task-id>
# Gemini CLI:
/ai-collaboration-installer:review-task <task-id>
# Codex CLI:
/prompts:ai-collaboration-installer-review-task <task-id>
```
...
- `/prompts:ai-collaboration-installer-review-task <task-id>` - 代码审查（提交前）
- `/prompts:ai-collaboration-installer-create-pr <target-branch>` - 创建 Pull Request（提交后）
- `/prompts:ai-collaboration-installer-complete-task <task-id>` - 归档任务（工作完成后）
